...
<?php echo "&nbsp;&nbsp;&nbsp;Dari ".$data['rajaongkir']['origin_details']['city_name'];?> Ke <?php echo $data['rajaongkir']['destination_details']['city_name'];?> @<?php echo $berat;?> gram dengan Kurir : <?php echo strtoupper($courier); ?>
